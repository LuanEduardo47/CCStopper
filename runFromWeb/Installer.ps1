...
$CCStopperAIOURL = "https://raw.githubusercontent.com/eaaasun/CCStopper/web/CCStopper_AIO.ps1"
$CCStopperLogoURL = "https://raw.githubusercontent.com/eaaasun/CCStopper/web/runFromWeb/icon.ico"
